  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#09090b] p-8 text-center">
      ...
      <p className="text-sm text-zinc-400 max-w-lg leading-relaxed">
        ...
        SSL certificate is still provisioning. In Clerk Dashboard → Domains, verify the domain and wait 5–30 minutes.
        If it persists, add apex CAA records for <span className="font-mono text-xs">pki.goog</span> and{" "}
