...
export default function CookieNotice() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-3xl flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 rounded-xl border border-white/10 bg-helm-card px-4 py-3.5 shadow-2xl">
