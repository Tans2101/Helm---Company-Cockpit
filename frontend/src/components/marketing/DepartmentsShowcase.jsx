  ...
  return (
    <section className="px-6 py-28 border-t border-helm-cream/[0.05]">
      <div className={`mx-auto ${maxWidth}`}>
        ...
        <div className="mt-14 border-t border-helm-cream/[0.06]">
          {items.map((dept, i) => (
            <motion.div
              key={dept.name}
              variants={fade}
              ...
              className="grid sm:grid-cols-[9rem_1fr] gap-2 sm:gap-8 py-6 border-b border-helm-cream/[0.06]"
            >
              <h3 className="font-display text-base text-helm-cream tracking-tight pt-0.5">{dept.name}</h3>
