    ...
    <div className="min-h-screen bg-helm-ink text-helm-cream">
      <div className="relative z-10 mx-auto max-w-3xl px-6 py-16 md:py-24">
        ...
        <div className="mt-10 space-y-8 text-[15px] text-helm-cream/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg text-helm-cream font-normal tracking-tight mb-2">Account &amp; profile data</h2>
            <p>
              When you sign up, we collect your name, email address, and company information needed to create your
              workspace. Authentication is handled by <span className="text-helm-cream">Clerk</span>; we receive basic
          ...
          <section>
            <h2 className="text-lg text-helm-cream font-normal tracking-tight mb-2">Uploaded documents</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg text-helm-cream font-normal tracking-tight mb-2">CRM data (HubSpot)</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg text-helm-cream font-normal tracking-tight mb-2">QuickBooks &amp; Xero data</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg text-helm-cream font-normal tracking-tight mb-2">Payments</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg text-helm-cream font-normal tracking-tight mb-2">Email</h2>
            <p>
              Transactional emails (for example invitations or notices) are sent through{" "}
              <span className="text-helm-cream">Resend</span>. Email addresses and message metadata needed to deliver those
          ...
          <section>
            <h2 className="text-lg text-helm-cream font-normal tracking-tight mb-2">Cookies &amp; session</h2>
            <p>
