        ...
        <div className="space-y-3 mb-6" data-testid="production-chain">
          {stages.map((stage, index) => (
            <GlassCard
              ...
              className={cn(
                "p-4 fade-up cursor-pointer transition-colors hover:border-helm-gold/30",
                selectedId === stage.id && "border-helm-gold/40 bg-helm-gold/[0.04]",
              )}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0 space-y-2">
                  <div className="flex items-center gap-2 flex-wrap">
                    <p className="text-sm text-helm-fg truncate">{stage.name}</p>
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
          ...
          <GlassCard className="relative w-full sm:max-w-lg m-0 sm:m-4 rounded-t-2xl sm:rounded-2xl p-6" data-testid="production-stage-panel">
            <div className="flex items-center justify-between mb-5">
              <h3 className="text-lg text-helm-fg font-light">Stage details</h3>
            ...
            <div className="space-y-3">
              <label className="block text-xs text-helm-muted">Name
                <input
                  ...
                  className="mt-1 w-full rounded-md border border-helm-line bg-helm-card text-helm-fg text-sm px-3 py-2 disabled:opacity-60"
                />
              </label>
              ...
              <div>
                ...
                <div className="max-h-40 overflow-y-auto space-y-1.5 rounded-md border border-helm-line p-2">
              ...
              <label className="block text-xs text-helm-muted">Notes
                <textarea
            ...
            <div className="mt-5 flex items-center gap-2">
              ...
              {canStructure && (
                <button
                  ...
                  className="rounded-md border border-helm-status-negative/40 text-helm-status-negative p-2.5 hover:bg-helm-status-negative/10 disabled:opacity-60"
                  title="Delete stage"
                >
