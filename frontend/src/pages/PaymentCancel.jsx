  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-helm-ink grain p-6">
      <div className="max-w-md w-full text-center relative z-10">
        ...
        <h1 className="font-display text-3xl font-normal text-white">No worries — nothing was charged.</h1>
        <p className="text-zinc-500 mt-3">You can activate Helm whenever you're ready.</p>
