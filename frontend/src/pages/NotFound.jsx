...
export default function NotFound() {
      ...
      <EmptyState
        ...
        action={
          <Link
            ...
            className="inline-flex items-center rounded-md bg-gold text-black font-medium text-sm px-4 py-2 hover:bg-gold-hover"
          >
            {homeLabel}
          </Link>
        }
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white grain overflow-x-hidden flex flex-col" data-testid="not-found">
